...
public class EmailManagerImpl implements EmailManager {
	...
	public void enviarEmailPerguntaParaVendedor(PerguntaResponse perguntaResponse) {
		 ...
		 * email.setSubject("Nova pergunta no seu produto: " +
		 * perguntaResponse.getNomeProduto());
		 * email.setText(perguntaResponse.getTituloPergunta()); // enviar(email);
		 */	}
	...
	public void enviarEmailVendaParaVendedor(CompraResponse compraResponse) {
		 ...
		 * email.setSubject("Nova venda no seu produto: " +
		 * compraResponse.getNomeProduto());
		 * email.setText("Foi registrada uma venda do seu produto: " +
		 * compraResponse.getNomeProduto() + ", Foram compradas: " +
		 * compraResponse.getQuantidade() + " unidades, o status atual da venda é: " +
		 * compraResponse.getStatus() + " O usuario que realizou a compra é o: " +
		 * compraResponse.getIdentificacaoUsuario()); // enviar(email);
		 */	}
	...
	public void enviarEmailCompraBemSucedidaParaCliente(Compra compra) {
		 ...
		 * email.setSubject("Pagamento aceito para o produto: " +
		 * compra.getProduto().getNome());
		 * email.setText("O metodo pagamento escolhido foi: " +
		 * compra.getGatewayPagamento() + ", Foram compradas: " + compra.getQuantidade()
		 * + " unidades, o status atual da venda é: Sucesso" +
		 * ", O vendedor do seu produto foi: " +
		 * compra.getProduto().getUsuario().getLogin()); // enviar(email);
		 */	}
	...
	public void enviarEmailCompraMalSucedidaParaCliente(Compra compra) {
		 ...
		 * // SimpleMailMessage email = new SimpleMailMessage();
		 * email.setTo(compra.getUsuario().getLogin());
		 * email.setSubject("Pagamento foi recusado para o produto: " +
		 * compra.getProduto().getNome());
		 * email.setText("O metodo pagamento escolhido foi: " +
		 * compra.getGatewayPagamento() + " o status atual da venda é: Recusado"); //
		 * enviar(email);
		 */	}
